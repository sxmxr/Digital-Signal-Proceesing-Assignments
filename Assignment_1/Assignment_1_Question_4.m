% Name : Samarth Shah
% Roll No: AU1841145
% Lab1 (Question_4) Generate the function for signal multiplication. For Two sequences x1(n) ={1,-1,2,5,1,5,-1} and x2(n) ={-2,-8,9,4,2,3,5}.
clear all;
clc ;
close all ;
...
output = multiplicationOfSignals( input_series1 , range_series1 , input_series2 , range_series2 ); % calling function
